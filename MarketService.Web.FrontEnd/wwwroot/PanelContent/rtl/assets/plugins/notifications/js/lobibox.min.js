...
!(function () {
    ...
    var LobiboxBase = {
        ...
        setPosition: function (left, top) {
            var pos;
            return "number" == typeof left && "number" == typeof top ? (pos = { left: left, top: top }) : "string" == typeof left && (pos = this._calculatePosition(left)), this.$el.css(pos), this;
        },
        ...
        show: function () {
            ...
            return (
                me.$options.modal && ($body.addClass(Lobibox.base.OPTIONS.bodyClass), me._addBackdrop()),
                me.$options.delay !== !1 &&
                setTimeout(function () {
                    me.destroy();
                }, me.$options.delay),
    ...
    (Lobibox.base = {}),
        (Lobibox.base.OPTIONS = {
            ...
            icons: {
                ...
                fontAwesome: { confirm: "fa fa-question-circle", success: "fa fa-check-circle", error: "fa fa-times-circle", warning: "fa fa-exclamation-circle", info: "fa fa-info-circle" },
            },
        }),
        ...
        (LobiboxPrompt.prototype = $.extend({}, LobiboxBase, {
            ...
            _processInput: function (options) {
                ...
                return (mergedOptions.buttons = { ok: Lobibox.base.OPTIONS.buttons.ok, cancel: Lobibox.base.OPTIONS.buttons.cancel }), (options = $.extend({}, mergedOptions, LobiboxPrompt.DEFAULT_OPTIONS, options));
            },
            _init: function () {
                var me = this;
            ...
            _createInput: function () {
                var label,
                    me = this;
                return (
                    (me.$input = me.$options.multiline ? $("<textarea></textarea>").attr("rows", me.$options.lines) : $('<input type="' + me.$promptType + '"/>')),
            ...
            isValid: function () {
                ...
                return me.$options.required && !me.getValue()
                    ? (me.$input.addClass("invalid"), 0 === $error.length && (me.$el.find(".lobibox-body").append('<p class="lobibox-input-error-message">' + me.$options.errorMessage + "</p>"), me._position(), me.$input.focus()), !1)
                    : (me.$input.removeClass("invalid"), $error.remove(), me._position(), me.$input.focus(), !0);
            },
        })),
        (LobiboxPrompt.DEFAULT_OPTIONS = { width: 400, attrs: {}, value: "", multiline: !1, lines: 3, type: "text", label: "", required: !0, errorMessage: "The field is required" }),
        (LobiboxConfirm.prototype = $.extend({}, LobiboxBase, {
            constructor: LobiboxConfirm,
            _processInput: function (options) {
                var me = this,
                    mergedOptions = LobiboxBase._processInput.call(me, options);
                return (mergedOptions.buttons = { yes: Lobibox.base.OPTIONS.buttons.yes, no: Lobibox.base.OPTIONS.buttons.no }), (options = $.extend({}, mergedOptions, Lobibox.confirm.DEFAULTS, options));
            },
            _init: function () {
                var me = this;
                LobiboxBase._init.call(me), me.show();
        ...
        (Lobibox.alert.OPTIONS = { warning: { title: "Warning" }, info: { title: "Information" }, success: { title: "Success" }, error: { title: "Error" } }),
        ...
        (Lobibox.progress.DEFAULTS = { width: 500, showProgressLabel: !0, label: "", progressTpl: !1, progressUpdated: null, progressCompleted: null }),
        (LobiboxWindow.prototype = $.extend({}, LobiboxBase, {
            ...
            _processInput: function (options) {
                var me = this,
                    mergedOptions = LobiboxBase._processInput.call(me, options);
                return (
                    options.content && "function" == typeof options.content && (options.content = options.content()),
            ...
            load: function (callback) {
                ...
                return me.$options.url
                    ? ($.ajax(me.$options.url, { method: me.$options.loadMethod, data: me.$options.params }).done(function (res) {
...
!(function () {
    var LobiboxNotify = function (type, options) {
        ...
        var me = this,
            _processInput = function (options) {
                return (
                    ("mini" === options.size || "large" === options.size) && (options = $.extend({}, Lobibox.notify.OPTIONS[options.size], options)),
            ...
            _createNotifyWrapper = function () {
                ...
                return (
                    ...
                    (($wrapper = $("<div></div>").addClass(selector.replace(/\./g, " ").trim()).appendTo($("body"))),
                        "large" === me.$options.size && $wrapper.append($('<ul class="lb-notify-tabs"></ul>')).append($('<div class="lb-notify-wrapper"></div>'))),
                    $wrapper
                );
            },
            _createNotify = function () {
                ...
                return (
                    ...
                    ($body = $("<div></div>", { class: "lobibox-notify-body" }).append($msg).appendTo($notify)),
        ...
        (this.remove = function () {
            ...
            (me._init = function () {
                ...
                } else $("body").append($notify), $notify.css({ position: "fixed", left: me.$options.position.left, top: me.$options.position.top });
            ...
            (me.$options.showAfterPrevious && 0 !== Lobibox.notify.list.length) || this._init();
    };
    (Lobibox.notify = function (type, options) {
        ...
        (Lobibox.notify.OPTIONS = {
            ...
            default: { class: "lobibox-notify-default", title: "Default" },
            success: { class: "lobibox-notify-success", title: "Success" },
            error: { class: "lobibox-notify-error", title: "Error"  },
            warning: { class: "lobibox-notify-warning", title: "Warning" },
            info: { class: "lobibox-notify-info", title: "Information"  },
            icons: {
                bootstrap: { success: "glyphicon glyphicon-ok-sign", error: "glyphicon glyphicon-remove-sign", warning: "glyphicon glyphicon-exclamation-sign", info: "glyphicon glyphicon-info-sign" },
