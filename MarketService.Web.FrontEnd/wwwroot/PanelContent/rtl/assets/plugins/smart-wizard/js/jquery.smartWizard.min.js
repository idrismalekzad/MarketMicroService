                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.main.addClass("sw"),
                                ...
                                (!0 === this.options.anchorSettings.enableAllAnchors && !0 === this.options.anchorSettings.anchorClickable) || this.steps.addClass("inactive"),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return (
                                ...
                                v.each(this.options.toolbarSettings.toolbarExtraButtons, function (t, e) {
                                    s.append(e.clone(!0));
                                }),
                                s.css("text-align", this.options.toolbarSettings.toolbarButtonPosition),
                                s
                            );
                        },
                    },
                        ...
                        value: function (e) {
                            ...
                            o
                                ? "object" == _typeof(o)
                                    ...
                                    : ("string" == typeof o && this._setStepContent(e, o), this._transitStep(e))
                                : this._transitStep(e);
                        },
                    },
                    {
                        ...
                        value: function (s) {
                            ...
                            this._setURLHash(n.attr("href")),
                                this._setAnchor(s),
                                this._doStepAnimation(s, function () {
                                    i._fixHeight(s);
                            ...
                            switch ((this._stopAnimations(), o)) {
                                ...
                                case "slide-h":
                                    ...
                                    t > this.current_index && ((l = -1 * h), (u = h)),
                                        null == this.current_index && this.container.height(n.outerHeight()),
                                        i &&
                                        ((a = i.css("position")),
                                            (r = i.css("left")),
                                            i
                                                ...
                                                .css("left", 0)
                                                .animate({ left: l }, this.options.transition.speed, this.options.transition.easing, function () {
                                        ...
                                        n
                                            ...
                                            .outerWidth(h)
                                            .show()
                                            .animate({ left: 0 }, this.options.transition.speed, this.options.transition.easing, function () {
                                ...
                                case "slide-v":
                                    var c,
                                        ...
                                        f = d,
                                        _ = -2 * d;
                                    t > this.current_index && ((f = -1 * d), (_ = d)),
                                        i &&
                                        ((c = i.css("position")),
                                            (p = i.css("top")),
                                            i
                                                .css("position", "absolute")
                                                .css("top", 0)
                                                .animate({ top: f }, this.options.transition.speed, this.options.transition.easing, function () {
                                        ...
                                        n
                                            ...
                                            .css("top", _)
                                            .show()
                                            .animate({ top: 0 }, this.options.transition.speed, this.options.transition.easing, function () {
                                ...
                                case "slide-s":
                                    i
                                        ? i.slideUp("fast", this.options.transition.easing, function () {
                                ...
                                case "fade":
                                    i
                                        ? i.fadeOut("fast", this.options.transition.easing, function () {
                        ...
                        value: function (t) {
                            this._resetCSSClass(this.current_index, "active"),
                                ...
                                (this._setCSSClass(this.current_index, "done"),
                                    !1 !== this.options.anchorSettings.removeDoneStepOnNavigateBack && "backward" === this._getStepDirection(t) && this._resetCSSClass(this.current_index, "done")),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            if (!this.options.cycleSteps)
                                switch ((this.main.find(".sw-btn-prev").removeClass("disabled"), this.main.find(".sw-btn-next").removeClass("disabled"), this._getStepPosition(t))) {
                                    case "first":
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            if (this.options.autoAdjustHeight) {
                                ...
                                this.container.finish().animate({ height: e.outerHeight() }, this.options.transition.speed);
                            }
                        },
                    },
                    {
